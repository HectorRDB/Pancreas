...
Rscript --verbose  garbage.R -n 32 -l $loc -o $out -S "1.2.50" -C "0" -m "k_45" > baron.out 2>&1
...
Rscript --verbose  garbage.R -n 32 -l $loc -o $out -S "1.2.50" -C "0" -m "k_45" > segerstolpe.out 2>&1

...
Rscript --verbose  Dune.R -n 32 -l $loc -o $out -S "1.7.30" -C "15" -m "k_15" -r $rsec > baron2.out 2>&1
...
Rscript --verbose  Dune.R -n 32 -l $loc -o $out -S "1.7.30" -C "15" -m "k_15" -r $rsec > segerstolpe2.out 2>&1

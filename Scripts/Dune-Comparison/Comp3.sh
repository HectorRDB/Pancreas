...
Rscript --verbose  Dune.R -n 16 -l $loc -o $out -S "1.5.50" -C "10" -m "k_25" -r $rsec > baron3.out 2>&1
...
Rscript --verbose  Dune.R -n 16 -l $loc -o $out -S "1.5.50" -C "10" -m "k_25" -r $rsec > segerstolpe3.out 2>&1

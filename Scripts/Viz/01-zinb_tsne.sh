...
out="/accounts/projects/epurdom/singlecell/Pancreas/Data/tSNE/baron.csv"
  Rscript --verbose  01-zinb_tsne.R -l $loc -o $out -K 1 > 1-baron.out 2>&1
...
# Rscript --verbose  01-zinb_tsne.R -l $loc -o $out -k 3 > 1-muraro.out 2>&1
...
out="/accounts/projects/epurdom/singlecell/Pancreas/Data/tSNE/segerstolpecsv"
  Rscript --verbose  01-zinb_tsne.R -l $loc -o $out -K 2 > 2-segerstolpe.out 2>&1

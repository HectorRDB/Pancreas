...
Rscript --verbose  1-filtering.R -l $loc -o $out -c 5 -m $meta -r 1 > 1-baron.out 2>&1
...
Rscript --verbose  1-filtering.R -l $loc -o $out -c 5 -m $meta -r 3 > 1-segerstolpe.out 2>&1
#
# echo "xin"
